...
Vector4 Matrix4x4::row(int index) const
{
...
Vector4 Matrix4x4::column(int index) const
{
...
void Matrix4x4::setRow(int index, const Vector4 &vec4)
{
...
void Matrix4x4::setColumn(int index, const Vector4 &vec4)
{
...
void Matrix4x4::fromAxes(const Vector4 &xAxis, const Vector4 &yAxis,
...
void Matrix4x4::inverse(const Matrix4x4 &mat4, Matrix4x4 &result)
{
    
}

void Matrix4x4::transpose(const Matrix4x4 &mat4, Matrix4x4 &result)
{
...
void Matrix4x4::add(const Matrix4x4 &left, const Matrix4x4 &right, Matrix4x4 &result)
{
...
void Matrix4x4::subtract(const Matrix4x4 &left, const Matrix4x4 &right, Matrix4x4 &result)
{
    result.m_mat[0][0] = left.m_mat[0][0] - right.m_mat[0][0];
    result.m_mat[0][1] = left.m_mat[0][1] - right.m_mat[0][1];
    result.m_mat[0][2] = left.m_mat[0][2] - right.m_mat[0][2];
...
void Matrix4x4::multiply(const Matrix4x4 &left, const Matrix4x2 &right, Matrix4x2 &result)
{
...
void Matrix4x4::multiply(const Matrix4x4 &left, const Matrix4x3 &right, Matrix4x3 &result)
{
    result.m_mat[0][0] = left.m_mat[0][0] * right.m_mat[0][0] + left.m_mat[0][1] * right.m_mat[1][0] + 
                         left.m_mat[0][2] * right.m_mat[2][0] + left.m_mat[0][3] * right.m_mat[3][0];
    result.m_mat[0][1] = left.m_mat[0][0] * right.m_mat[0][1] + left.m_mat[0][1] * right.m_mat[1][1] + 
...
void Matrix4x4::multiply(const Matrix4x4 &left, const Matrix4x4 &right, Matrix4x4 &result)
{
    result.m_mat[0][0] = left.m_mat[0][0] * right.m_mat[0][0] + left.m_mat[0][1] * right.m_mat[1][0] + 
                         left.m_mat[0][2] * right.m_mat[2][0] + left.m_mat[0][3] * right.m_mat[3][0];
    result.m_mat[0][1] = left.m_mat[0][0] * right.m_mat[0][1] + left.m_mat[0][1] * right.m_mat[1][1] + 
...
void Matrix4x4::multiply(const Matrix4x4 &left, float right, Matrix4x4 &result)
{
...
void Matrix4x4::multiply(float left, const Matrix4x4 &right, Matrix4x4 &result)
{
...
void Matrix4x4::multiply(const Matrix4x4 &left, const Vector4 &right, Vector4 &result)
{
...
void Matrix4x4::multiply(const Vector4 &left, const Matrix4x4 &right, Vector4 &result)
{
...
Matrix4x4 Matrix4x4::subtract(const Matrix4x4 &left, const Matrix4x4 &right)
{
    Matrix4x4 result;
...
Matrix4x4 Matrix4x4::multiply(const Matrix4x4 &left, float right)
{
    Matrix4x4 result;
...
Matrix4x4 Matrix4x4::multiply(float left, const Matrix4x4 &right)
{
    Matrix4x4 result;
    multiply(left, right, result);
    return result;
...
Matrix4x2 Matrix4x4::multiply(const Matrix4x4 &left, const Matrix4x2 &right)
{
    Matrix4x2 result;
    multiply(left, right, result);
    return result;
...
Matrix4x3 Matrix4x4::multiply(const Matrix4x4 &left, const Matrix4x3 &right)
{
    Matrix4x3 result;
    multiply(left, right, result);
    return result;
...
Vector4 Matrix4x4::multiply(const Vector4 &left, const Matrix4x4 &right)
{
    Vector4 result;
    multiply(left, right, result);
    return result;
...
Matrix4x2 operator*(const Matrix4x4 &m44, const Matrix4x2 &m42)
{
    return Matrix4x4::multiply(m44, m42);
}

Matrix4x3 operator*(const Matrix4x4 &m44, const Matrix4x3 &m43)
{
    return Matrix4x4::multiply(m44, m43);
}

Vector4 operator*(const Matrix4x4 &mat4, const Vector4 &vec4)
{
    return Matrix4x4::multiply(mat4, vec4);
}

Vector4 operator*(const Vector4 &vec4, const Matrix4x4 &mat4)
{
