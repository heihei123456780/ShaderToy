...
Matrix4x3::Matrix4x3(float value)
{
    m_mat[0][0] = value;
    m_mat[0][1] = value;
    m_mat[0][2] = value;
...
Matrix4x3::Matrix4x3(float arr[4][3])
{
    m_mat[0][0] = arr[0][0];
    m_mat[0][1] = arr[0][1];
    m_mat[0][2] = arr[0][2];
...
Matrix4x3::Matrix4x3(float f00, float f01, float f02,
...
Matrix4x3::Matrix4x3(const Matrix4x3 &mat43)
{
...
Vector3 Matrix4x3::row(int index) const
{
...
Vector4 Matrix4x3::column(int index) const
{    
...
void Matrix4x3::setRow(int index, const Vector3 &vec3)
{
...
void Matrix4x3::setColumn(int index, const Vector4 &vec4)
{
...
void Matrix4x3::inverse(const Matrix4x3 &mat43, Matrix4x3 &result)
{
}

void Matrix4x3::transpose(const Matrix4x3 &mat43, Matrix3x4 &result)
{
...
void Matrix4x3::add(const Matrix4x3 &left, const Matrix4x3 &right, Matrix4x3 &result)
{
...
void Matrix4x3::subtract(const Matrix4x3 &left, const Matrix4x3 &right, Matrix4x3 &result)
{
    result.m_mat[0][0] = left.m_mat[0][0] - right.m_mat[0][0];
    result.m_mat[0][1] = left.m_mat[0][1] - right.m_mat[0][1];
    result.m_mat[0][2] = left.m_mat[0][2] - right.m_mat[0][2];
...
void Matrix4x3::multiply(const Matrix4x3 &left, float right, Matrix4x3 &result)
{
...
void Matrix4x3::multiply(float left, const Matrix4x3 &right, Matrix4x3 &result)
{
...
void Matrix4x3::multiply(const Matrix4x3 &left, const Matrix3x2 &right, Matrix4x2 &result)
{
...
void Matrix4x3::multiply(const Matrix4x3 &left, const Matrix3x3 &right, Matrix4x3 &result)
{
    result.m_mat[0][0] = left.m_mat[0][0] * right.m_mat[0][0] + left.m_mat[0][1] * right.m_mat[1][0] +
                         left.m_mat[0][2] * right.m_mat[2][0];
    result.m_mat[0][1] = left.m_mat[0][0] * right.m_mat[0][1] + left.m_mat[0][1] * right.m_mat[1][1] +
...
void Matrix4x3::multiply(const Matrix4x3 &left, const Matrix3x4 &right, Matrix4x4 &result)
{
    result.m_mat[0][0] = left.m_mat[0][0] * right.m_mat[0][0] + left.m_mat[0][1] * right.m_mat[1][0] +
                         left.m_mat[0][2] * right.m_mat[2][0];
    result.m_mat[0][1] = left.m_mat[0][0] * right.m_mat[0][1] + left.m_mat[0][1] * right.m_mat[1][1] +
...
void Matrix4x3::multiply(const Matrix4x3 &left, const Vector3 &right, Vector4 &result)
{
...
void Matrix4x3::multiply(const Vector4 &left, const Matrix4x3 &right, Vector3 &result)
{
...
Matrix4x3 Matrix4x3::inverse(const Matrix4x3 &mat43)
{
    Matrix4x3 result;
...
Matrix3x4 Matrix4x3::transpose(const Matrix4x3 &mat43)
{
    Matrix3x4 result;
...
Matrix4x3 Matrix4x3::subtract(const Matrix4x3 &left, const Matrix4x3 &right)
{
    Matrix4x3 result;
...
Matrix4x3 Matrix4x3::multiply(const Matrix4x3 &left, float right)
{
    Matrix4x3 result;
...
Matrix4x3 Matrix4x3::multiply(float left, const Matrix4x3 &right)
{
    Matrix4x3 result;
    multiply(left, right, result);
    return result;
...
Matrix4x2 Matrix4x3::multiply(const Matrix4x3 &left, const Matrix3x2 &right)
{
    Matrix4x2 result;
    multiply(left, right, result);
    return result;
...
Matrix4x3 Matrix4x3::multiply(const Matrix4x3 &left, const Matrix3x3 &right)
{
    Matrix4x3 result;
    multiply(left, right, result);
    return result;
...
Matrix4x4 Matrix4x3::multiply(const Matrix4x3 &left, const Matrix3x4 &right)
{
    Matrix4x4 result;
    multiply(left, right, result);
    return result;
...
Vector4 Matrix4x3::multiply(const Matrix4x3 &left, const Vector3 &right)
{
    Vector4 result;
    multiply(left, right, result);
    return result;
...
Vector3 Matrix4x3::multiply(const Vector4 &left, const Matrix4x3 &right)
{
    Vector3 result;
    multiply(left, right, result);
    return result;
...
Matrix4x3 &Matrix4x3::operator=(const Matrix4x3 &mat43)
{
    m_mat[0][0] = mat43.m_mat[0][0];
    m_mat[0][1] = mat43.m_mat[0][1];
    m_mat[0][2] = mat43.m_mat[0][2];
...
bool operator==(const Matrix4x3 &m1, const Matrix4x3 &m2)
{
    for (int r = 0; r < 4; r++)
    {
        for (int c = 0; c < 3; c++)
...
Matrix4x2 operator*(const Matrix4x3 &m43, const Matrix3x2 &m32)
{
    return Matrix4x3::multiply(m43, m32);
}

Matrix4x3 operator*(const Matrix4x3 &m43, const Matrix3x3 &m33)
{
    return Matrix4x3::multiply(m43, m33);
}

Matrix4x4 operator*(const Matrix4x3 &m43, const Matrix3x4 &m34)
{
    return Matrix4x3::multiply(m43, m34);
}

Vector4 operator*(const Matrix4x3 &mat43, const Vector3 &vec4)
{
    return Matrix4x3::multiply(mat43, vec4);
}

Vector3 operator*(const Vector4 &vec3, const Matrix4x3 &mat43)
{
