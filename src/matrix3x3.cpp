...
Matrix3x3::Matrix3x3(float f00, float f01, float f02,
...
Matrix3x3::Matrix3x3(const Matrix3x3 &mat3)
{
...
Vector3 Matrix3x3::column(int index) const
{    
...
void Matrix3x3::setRow(int index, const Vector3 &vec3)
{
...
void Matrix3x3::setColumn(int index, const Vector3 &vec3)
{
...
void Matrix3x3::fill(float value)
{
    m_mat[0][0] = value;
    m_mat[0][1] = value;
    m_mat[0][2] = value;
...
void Matrix3x3::inverse(const Matrix3x3 &mat3, Matrix3x3 &result)
{
...
void Matrix3x3::transpose(const Matrix3x3 &mat3, Matrix3x3 &result)
{
...
void Matrix3x3::multiply(float left, const Matrix3x3 &right, Matrix3x3 &result)
{
...
void Matrix3x3::multiply(const Matrix3x3 &left, const Matrix3x2 &right, Matrix3x2 &result)
{
...
void Matrix3x3::multiply(const Matrix3x3 &left, const Matrix3x4 &right, Matrix3x4 &result)
{
    result.m_mat[0][0] = left.m_mat[0][0] * right.m_mat[0][0] + left.m_mat[0][1] * right.m_mat[1][0] + 
                         left.m_mat[0][2] * right.m_mat[2][0];
    result.m_mat[0][1] = left.m_mat[0][0] * right.m_mat[0][1] + left.m_mat[0][1] * right.m_mat[1][1] + 
...
void Matrix3x3::multiply(const Matrix3x3 &left, const Vector3 &right, Vector3 &result)
{
...
void Matrix3x3::multiply(const Vector3 &left, const Matrix3x3 &right, Vector3 &result)
{
...
Matrix3x3 Matrix3x3::inverse(const Matrix3x3 &mat3)
{
    Matrix3x3 result;
    inverse(mat3, result);
    return result;
...
Matrix3x3 Matrix3x3::transpose(const Matrix3x3 &mat3)
{
    Matrix3x3 result;
...
Matrix3x3 Matrix3x3::add(const Matrix3x3 &left, const Matrix3x3 &right)
{
    Matrix3x3 result;
...
Matrix3x3 Matrix3x3::subtract(const Matrix3x3 &left, const Matrix3x3 &right)
{
    Matrix3x3 result;
...
Matrix3x3 Matrix3x3::multiply(const Matrix3x3 &left, float right)
{
    Matrix3x3 result;
...
Matrix3x3 Matrix3x3::multiply(float left, const Matrix3x3 &right)
{
    Matrix3x3 result;
    multiply(left, right, result);
    return result;
...
Matrix3x2 Matrix3x3::multiply(const Matrix3x3 &left, const Matrix3x2 &right)
{
    Matrix3x2 result;
    multiply(left, right, result);
    return result;
...
Matrix3x4 Matrix3x3::multiply(const Matrix3x3 &left, const Matrix3x4 &right)
{
    Matrix3x4 result;
    multiply(left, right, result);
    return result;
...
Vector3 Matrix3x3::multiply(const Vector3 &left, const Matrix3x3 &right)
{
    Vector3 result;
    multiply(left, right, result);
    return result;
...
Matrix3x3 &Matrix3x3::operator=(const Matrix3x3 &mat3)
{
    m_mat[0][0] = mat3.m_mat[0][0];
    m_mat[0][1] = mat3.m_mat[0][1];
    m_mat[0][2] = mat3.m_mat[0][2];
...
Matrix3x2 operator*(const Matrix3x3 &m33, const Matrix3x2 &m32)
{
    return Matrix3x3::multiply(m33, m32);
}

Matrix3x4 operator*(const Matrix3x3 &m33, const Matrix3x4 &m34)
{
    return Matrix3x3::multiply(m33, m34);
}

Vector3 operator*(const Matrix3x3 &mat3, const Vector3 &vec3)
{
    return Matrix3x3::multiply(mat3, vec3);
}

Vector3 operator*(const Vector3 &vec3, const Matrix3x3 &mat3)
{
