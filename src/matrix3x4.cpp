...
Matrix3x4::Matrix3x4(float value)
{
    m_mat[0][0] = value;
    m_mat[0][1] = value;
    m_mat[0][2] = value;
...
Matrix3x4::Matrix3x4(float arr[3][4])
{
    m_mat[0][0] = arr[0][0];
    m_mat[0][1] = arr[0][1];
    m_mat[0][2] = arr[0][2];
...
Matrix3x4::Matrix3x4(float f00, float f01, float f02, float f03,
...
Matrix3x4::Matrix3x4(const Matrix3x4 &mat34)
{
...
Vector3 Matrix3x4::row(int index) const
{
...
Vector3 Matrix3x4::column(int index) const
{    
...
void Matrix3x4::setRow(int index, const Vector4 &vec4)
{
...
void Matrix3x4::setColumn(int index, const Vector3 &vec3)
{
...
void Matrix3x4::fill(float value)
{
    m_mat[0][0] = value;
    m_mat[0][1] = value;
    m_mat[0][2] = value;
...
void Matrix3x4::inverse(const Matrix3x4 &mat34, Matrix3x4 &result)
{
}

void Matrix3x4::transpose(const Matrix3x4 &mat34, Matrix4x3 &result)
{
...
void Matrix3x4::add(const Matrix3x4 &left, const Matrix3x4 &right, Matrix3x4 &result)
{
...
void Matrix3x4::subtract(const Matrix3x4 &left, const Matrix3x4 &right, Matrix3x4 &result)
{
    result.m_mat[0][0] = left.m_mat[0][0] - right.m_mat[0][0];
    result.m_mat[0][1] = left.m_mat[0][1] - right.m_mat[0][1];
    result.m_mat[0][2] = left.m_mat[0][2] - right.m_mat[0][2];
...
void Matrix3x4::multiply(const Matrix3x4 &left, float right, Matrix3x4 &result)
{
...
void Matrix3x4::multiply(float left, const Matrix3x4 &right, Matrix3x4 &result)
{
...
void Matrix3x4::multiply(const Matrix3x4 &left, const Matrix4x2 &right, Matrix3x2 &result)
{
...
void Matrix3x4::multiply(const Matrix3x4 &left, const Matrix4x3 &right, Matrix3x3 &result)
{
    result.m_mat[0][0] = left.m_mat[0][0] * right.m_mat[0][0] + left.m_mat[0][1] * right.m_mat[1][0] + 
                         left.m_mat[0][2] * right.m_mat[2][0] + left.m_mat[0][3] * right.m_mat[3][0];
    result.m_mat[0][1] = left.m_mat[0][0] * right.m_mat[0][1] + left.m_mat[0][1] * right.m_mat[1][1] + 
...
void Matrix3x4::multiply(const Matrix3x4 &left, const Matrix4x4 &right, Matrix3x4 &result)
{
    result.m_mat[0][0] = left.m_mat[0][0] * right.m_mat[0][0] + left.m_mat[0][1] * right.m_mat[1][0] + 
                         left.m_mat[0][2] * right.m_mat[2][0] + left.m_mat[0][3] * right.m_mat[3][0];
    result.m_mat[0][1] = left.m_mat[0][0] * right.m_mat[0][1] + left.m_mat[0][1] * right.m_mat[1][1] + 
...
void Matrix3x4::multiply(const Matrix3x4 &left, const Vector4 &right, Vector3 &result)
{
...
void Matrix3x4::multiply(const Vector3 &left, const Matrix3x4 &right, Vector4 &result)
{
...
Matrix3x4 Matrix3x4::inverse(const Matrix3x4 &mat34)
{
    Matrix3x4 result;
...
Matrix4x3 Matrix3x4::transpose(const Matrix3x4 &mat34)
{
    Matrix4x3 result;
...
Matrix3x4 Matrix3x4::add(const Matrix3x4 &left, const Matrix3x4 &right)
{
    Matrix3x4 result;
...
Matrix3x4 Matrix3x4::subtract(const Matrix3x4 &left, const Matrix3x4 &right)
{
    Matrix3x4 result;
...
Matrix3x4 Matrix3x4::multiply(const Matrix3x4 &left, float right)
{
    Matrix3x4 result;
...
Matrix3x4 Matrix3x4::multiply(float left, const Matrix3x4 &right)
{
    Matrix3x4 result;
    multiply(left, right, result);
    return result;
...
Matrix3x2 Matrix3x4::multiply(const Matrix3x4 &left, const Matrix4x2 &right)
{
    Matrix3x2 result;
    multiply(left, right, result);
    return result;
...
Matrix3x3 Matrix3x4::multiply(const Matrix3x4 &left, const Matrix4x3 &right)
{
    Matrix3x3 result;
    multiply(left, right, result);
    return result;
...
Matrix3x4 Matrix3x4::multiply(const Matrix3x4 &left, const Matrix4x4 &right)
{
    Matrix3x4 result;
    multiply(left, right, result);
    return result;
...
Vector3 Matrix3x4::multiply(const Matrix3x4 &left, const Vector4 &right)
{
    Vector3 result;
    multiply(left, right, result);
    return result;
...
Vector4 Matrix3x4::multiply(const Vector3 &left, const Matrix3x4 &right)
{
    Vector4 result;
    multiply(left, right, result);
    return result;
...
Matrix3x4 &Matrix3x4::operator=(const Matrix3x4 &mat34)
{
    m_mat[0][0] = mat34.m_mat[0][0];
    m_mat[0][1] = mat34.m_mat[0][1];
    m_mat[0][2] = mat34.m_mat[0][2];
...
Matrix3x2 operator*(const Matrix3x4 &m34, const Matrix4x2 &m42)
{
    return Matrix3x4::multiply(m34, m42);
}

Matrix3x3 operator*(const Matrix3x4 &m34, const Matrix4x3 &m43)
{
    return Matrix3x4::multiply(m34, m43);
}

Matrix3x4 operator*(const Matrix3x4 &m34, const Matrix4x4 &m44)
{
    return Matrix3x4::multiply(m34, m44);
}

Vector3 operator*(const Matrix3x4 &mat34, const Vector4 &vec4)
{
    return Matrix3x4::multiply(mat34, vec4);
}

Vector4 operator*(const Vector3 &vec3, const Matrix3x4 &mat34)
{
