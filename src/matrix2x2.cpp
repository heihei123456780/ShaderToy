...
Matrix2x2::Matrix2x2(float arr[2][2])
{
    m_mat[0][0] = arr[0][0];
    m_mat[0][1] = arr[0][1];
    m_mat[1][0] = arr[1][0];
...
Matrix2x2::Matrix2x2(float f00, float f01,
                     float f10, float f11)
{
    m_mat[0][0] = f00;
    m_mat[0][1] = f01;
...
Matrix2x2::Matrix2x2(const Matrix2x2 &mat2)
{
...
Vector2 Matrix2x2::row(int index) const
{
    return Vector2(m_mat[0][index],
                   m_mat[1][index]);
}

Vector2 Matrix2x2::column(int index) const
{
    return Vector2(m_mat[index][0],
                   m_mat[index][1]);
}

void Matrix2x2::setColumn(int index, const Vector2 &vec3)
{
    m_mat[0][index] = vec3.x();
    m_mat[1][index] = vec3.y();
}

void Matrix2x2::setRow(int index, const Vector2 &vec3)
{
    m_mat[index][0] = vec3.x();
    m_mat[index][1] = vec3.y();
}

void Matrix2x2::fill(float value)
{
    m_mat[0][0] = value;
    m_mat[0][1] = value;
    m_mat[1][0] = value;
...
bool Matrix2x2::isAffine() const
{
    return (m_mat[0][0] == 1.0f &&
            m_mat[1][1] == 1.0f);
}

void Matrix2x2::fromAxes(const Vector2 &xAxis, const Vector2 &yAxis)
{
    setColumn(0, xAxis);
    setColumn(1, yAxis);
}
...
void Matrix2x2::inverse(const Matrix2x2 &mat2, Matrix2x2 &result)
{
...
void Matrix2x2::transpose(const Matrix2x2 &mat2, Matrix2x2 &result)
{
...
void Matrix2x2::add(const Matrix2x2 &left, const Matrix2x2 &right, Matrix2x2 &result)
{
...
void Matrix2x2::subtract(const Matrix2x2 &left, const Matrix2x2 &right, Matrix2x2 &result)
{
    result.m_mat[0][0] = left.m_mat[0][0] - right.m_mat[0][0];
    result.m_mat[0][1] = left.m_mat[0][1] - right.m_mat[0][1];
    result.m_mat[1][0] = left.m_mat[1][0] - right.m_mat[1][0];
...
void Matrix2x2::multiply(const Matrix2x2 &left, float right, Matrix2x2 &result)
{
...
void Matrix2x2::multiply(float left, const Matrix2x2 &right, Matrix2x2 &result)
{
...
void Matrix2x2::multiply(const Matrix2x2 &left, const Matrix2x2 &right, Matrix2x2 &result)
{
...
void Matrix2x2::multiply(const Matrix2x2 &left, const Matrix2x3 &right, Matrix2x3 &result)
{
    result.m_mat[0][0] = left.m_mat[0][0] * right.m_mat[0][0] + left.m_mat[0][1] * right.m_mat[1][0];
    result.m_mat[0][1] = left.m_mat[0][0] * right.m_mat[0][1] + left.m_mat[0][1] * right.m_mat[1][1];
...
void Matrix2x2::multiply(const Matrix2x2 &left, const Matrix2x4 &right, Matrix2x4 &result)
{
    result.m_mat[0][0] = left.m_mat[0][0] * right.m_mat[0][0] + left.m_mat[0][1] * right.m_mat[1][0];
    result.m_mat[0][1] = left.m_mat[0][0] * right.m_mat[0][1] + left.m_mat[0][1] * right.m_mat[1][1];
    result.m_mat[0][2] = left.m_mat[0][0] * right.m_mat[0][2] + left.m_mat[0][1] * right.m_mat[1][2];
...
void Matrix2x2::multiply(const Matrix2x2 &left, const Vector2 &right, Vector2 &result)
{
...
void Matrix2x2::multiply(const Vector2 &left, const Matrix2x2 &right, Vector2 &result)
{
...
Matrix2x2 Matrix2x2::add(const Matrix2x2 &left, const Matrix2x2 &right)
{
    Matrix2x2 result;
...
Matrix2x2 Matrix2x2::subtract(const Matrix2x2 &left, const Matrix2x2 &right)
{
    Matrix2x2 result;
...
Matrix2x2 Matrix2x2::multiply(const Matrix2x2 &left, float right)
{
    Matrix2x2 result;
...
Matrix2x2 Matrix2x2::multiply(float left, const Matrix2x2 &right)
{
    Matrix2x2 result;
    multiply(left, right, result);
    return result;
...
Matrix2x2 Matrix2x2::multiply(const Matrix2x2 &left, const Matrix2x2 &right)
{
    Matrix2x2 result;
    multiply(left, right, result);
    return result;
...
Matrix2x3 Matrix2x2::multiply(const Matrix2x2 &left, const Matrix2x3 &right)
{
    Matrix2x3 result;
    multiply(left, right, result);
    return result;
...
Matrix2x4 Matrix2x2::multiply(const Matrix2x2 &left, const Matrix2x4 &right)
{
    Matrix2x4 result;
    multiply(left, right, result);
    return result;
...
Vector2 Matrix2x2::multiply(const Matrix2x2 &left, const Vector2 &right)
{
    Vector2 result;
    multiply(left, right, result);
    return result;
...
Vector2 Matrix2x2::multiply(const Vector2 &left, const Matrix2x2 &right)
{
    Vector2 result;
    multiply(left, right, result);
    return result;
...
Matrix2x2 &Matrix2x2::operator=(const Matrix2x2 &mat2)
{
    m_mat[0][0] = mat2.m_mat[0][0];
    m_mat[0][1] = mat2.m_mat[0][1];
    m_mat[1][0] = mat2.m_mat[1][0];
...
Matrix2x3 operator*(const Matrix2x2 &m22, const Matrix2x3 &m23)
{
    return Matrix2x2::multiply(m22, m23);
}

Matrix2x4 operator*(const Matrix2x2 &m22, const Matrix2x4 &m24)
{
    return Matrix2x2::multiply(m22, m24);
}

Vector2 operator*(const Matrix2x2 &mat2, const Vector2 &vec2)
{
