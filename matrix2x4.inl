...
inline Matrix2x4::Matrix2x4(float value)
{
    m_mat[0][0] = value;
    m_mat[0][1] = value;
    m_mat[0][2] = value;
...
inline Matrix2x4::Matrix2x4(float arr[2][4])
{
    m_mat[0][0] = arr[0][0];
    m_mat[0][1] = arr[0][1];
    m_mat[0][2] = arr[0][2];
...
inline Matrix2x4::Matrix2x4(float f00, float f01, float f02, float f03,
...
inline Matrix2x4::Matrix2x4(const Matrix2x4 &mat24)
{
...
inline Vector4 Matrix2x4::row(int index) const
{
...
inline Vector2 Matrix2x4::column(int index) const
{
    return Vector2(m_mat[0][index],
                   m_mat[1][index]);
}

inline void Matrix2x4::setRow(int index, const Vector4 &vec4)
{
...
inline void Matrix2x4::setColumn(int index, const Vector2 &vec2)
{
    m_mat[0][index] = vec2.x();
    m_mat[1][index] = vec2.y();
}

inline void Matrix2x4::fill(float value)
{
    m_mat[0][0] = value;
    m_mat[0][1] = value;
    m_mat[0][2] = value;
...
inline void Matrix2x4::inverse(const Matrix2x4 &mat24, Matrix2x4 &result)
{
}

inline void Matrix2x4::transpose(const Matrix2x4 &mat24, Matrix4x2 &result)
{
...
inline void Matrix2x4::add(const Matrix2x4 &left, const Matrix2x4 &right, Matrix2x4 &result)
{
...
inline void Matrix2x4::subtract(const Matrix2x4 &left, const Matrix2x4 &right, Matrix2x4 &result)
{
    result.m_mat[0][0] = left.m_mat[0][0] - right.m_mat[0][0];
    result.m_mat[0][1] = left.m_mat[0][1] - right.m_mat[0][1];
    result.m_mat[0][2] = left.m_mat[0][2] - right.m_mat[0][2];
...
inline void Matrix2x4::multiply(const Matrix2x4 &left, float right, Matrix2x4 &result)
{
...
inline void Matrix2x4::multiply(float left, const Matrix2x4 &right, Matrix2x4 &result)
{
...
inline void Matrix2x4::multiply(const Matrix2x4 &left, const Matrix4x2 &right, Matrix2x2 &result)
{
...
inline void Matrix2x4::multiply(const Matrix2x4 &left, const Matrix4x3 &right, Matrix2x3 &result)
{
    result.m_mat[0][0] = left.m_mat[0][0] * right.m_mat[0][0] + left.m_mat[0][1] * right.m_mat[1][0] + 
                         left.m_mat[0][2] * right.m_mat[2][0] + left.m_mat[0][3] * right.m_mat[3][0];
    result.m_mat[0][1] = left.m_mat[0][0] * right.m_mat[0][1] + left.m_mat[0][1] * right.m_mat[1][1] + 
...
inline void Matrix2x4::multiply(const Matrix2x4 &left, const Matrix4x4 &right, Matrix2x4 &result)
{
    result.m_mat[0][0] = left.m_mat[0][0] * right.m_mat[0][0] + left.m_mat[0][1] * right.m_mat[1][0] + 
                         left.m_mat[0][2] * right.m_mat[2][0] + left.m_mat[0][3] * right.m_mat[3][0];
    result.m_mat[0][1] = left.m_mat[0][0] * right.m_mat[0][1] + left.m_mat[0][1] * right.m_mat[1][1] + 
...
inline void Matrix2x4::multiply(const Matrix2x4 &left, const Vector4 &right, Vector2 &result)
{
...
inline void Matrix2x4::multiply(const Vector2 &left, const Matrix2x4 &right, Vector4 &result)
{
...
inline Matrix2x4 Matrix2x4::inverse(const Matrix2x4 &mat24)
{
    Matrix2x4 result;
...
inline Matrix4x2 Matrix2x4::transpose(const Matrix2x4 &mat24)
{
    Matrix4x2 result;
...
inline Matrix2x4 Matrix2x4::add(const Matrix2x4 &left, const Matrix2x4 &right)
{
    Matrix2x4 result;
...
inline Matrix2x4 Matrix2x4::subtract(const Matrix2x4 &left, const Matrix2x4 &right)
{
    Matrix2x4 result;
...
inline Matrix2x4 Matrix2x4::multiply(const Matrix2x4 &left, float right)
{
    Matrix2x4 result;
...
inline Matrix2x4 Matrix2x4::multiply(float left, const Matrix2x4 &right)
{
    Matrix2x4 result;
    multiply(left, right, result);
    return result;
...
inline Matrix2x2 Matrix2x4::multiply(const Matrix2x4 &left, const Matrix4x2 &right)
{
    Matrix2x2 result;
    multiply(left, right, result);
    return result;
...
inline Matrix2x3 Matrix2x4::multiply(const Matrix2x4 &left, const Matrix4x3 &right)
{
    Matrix2x3 result;
    multiply(left, right, result);
    return result;
...
inline Matrix2x4 Matrix2x4::multiply(const Matrix2x4 &left, const Matrix4x4 &right)
{
    Matrix2x4 result;
    multiply(left, right, result);
    return result;
...
inline Vector2 Matrix2x4::multiply(const Matrix2x4 &left, const Vector4 &right)
{
    Vector2 result;
    multiply(left, right, result);
    return result;
...
inline Vector4 Matrix2x4::multiply(const Vector2 &left, const Matrix2x4 &right)
{
    Vector4 result;
    multiply(left, right, result);
    return result;
...
inline Matrix2x4 &Matrix2x4::operator=(const Matrix2x4 &mat24)
{
    m_mat[0][0] = mat24.m_mat[0][0];
    m_mat[0][1] = mat24.m_mat[0][1];
    m_mat[0][2] = mat24.m_mat[0][2];
...
inline bool operator==(const Matrix2x4 &m1, const Matrix2x4 &m2)
{
    for (int r = 0; r < 2; r++)
    {
        for (int c = 0; c < 4; c++)
...
inline Matrix2x2 operator*(const Matrix2x4 &m24, const Matrix4x2 &m42)
{
    return Matrix2x4::multiply(m24, m42);
}

inline Matrix2x3 operator*(const Matrix2x4 &m24, const Matrix4x3 &m43)
{
    return Matrix2x4::multiply(m24, m43);
}

inline Matrix2x4 operator*(const Matrix2x4 &m24, const Matrix4x4 &m44)
{
    return Matrix2x4::multiply(m24, m44);
}

inline Vector2 operator*(const Matrix2x4 &mat24, const Vector4 &vec4)
{
    return Matrix2x4::multiply(mat24, vec4);
}

inline Vector4 operator*(const Vector2 &vec2, const Matrix2x4 &mat24)
{
