...
Matrix2x3::Matrix2x3(float arr[2][3])
{
    m_mat[0][0] = arr[0][0];
    m_mat[0][1] = arr[0][1];
    m_mat[0][2] = arr[0][2];
...
Matrix2x3::Matrix2x3(float f00, float f01, float f02,
...
Matrix2x3::Matrix2x3(const Matrix2x3 &mat23)
{
...
Vector2 Matrix2x3::column(int index) const
{
    return Vector2(m_mat[0][index],
                   m_mat[1][index]);
}

Vector3 Matrix2x3::row(int index) const
{
...
void Matrix2x3::setRow(int index, const Vector3 &vec3)
{
...
void Matrix2x3::setColumn(int index, const Vector2 &vec2)
{
    m_mat[0][index] = vec2.x();
    m_mat[1][index] = vec2.y();
}

void Matrix2x3::fill(float value)
{
    m_mat[0][0] = value;
    m_mat[0][1] = value;
    m_mat[0][2] = value;
...
void Matrix2x3::inverse(const Matrix2x3 &mat23, Matrix2x3 &result)
{
}

void Matrix2x3::transpose(const Matrix2x3 &mat23, Matrix3x2 &result)
{
...
void Matrix2x3::add(const Matrix2x3 &left, const Matrix2x3 &right, Matrix2x3 &result)
{
...
void Matrix2x3::subtract(const Matrix2x3 &left, const Matrix2x3 &right, Matrix2x3 &result)
{
    result.m_mat[0][0] = left.m_mat[0][0] - right.m_mat[0][0];
    result.m_mat[0][1] = left.m_mat[0][1] - right.m_mat[0][1];
    result.m_mat[0][2] = left.m_mat[0][2] - right.m_mat[0][2];
...
void Matrix2x3::multiply(const Matrix2x3 &left, const Matrix3x2 &right, Matrix2x2 &result)
{
...
void Matrix2x3::multiply(const Matrix2x3 &left, const Matrix3x3 &right, Matrix2x3 &result)
{
    result.m_mat[0][0] = left.m_mat[0][0] * right.m_mat[0][0] + left.m_mat[0][1] * right.m_mat[1][0] + 
                         left.m_mat[0][2] * right.m_mat[2][0];
    result.m_mat[0][1] = left.m_mat[0][0] * right.m_mat[0][1] + left.m_mat[0][1] * right.m_mat[1][1] + 
...
void Matrix2x3::multiply(const Matrix2x3 &left, const Matrix3x4 &right, Matrix2x4 &result)
{
    result.m_mat[0][0] = left.m_mat[0][0] * right.m_mat[0][0] + left.m_mat[0][1] * right.m_mat[1][0] + 
                         left.m_mat[0][2] * right.m_mat[2][0];
    result.m_mat[0][1] = left.m_mat[0][0] * right.m_mat[0][1] + left.m_mat[0][1] * right.m_mat[1][1] + 
...
void Matrix2x3::multiply(const Matrix2x3 &left, float right, Matrix2x3 &result)
{
...
void Matrix2x3::multiply(float left, const Matrix2x3 &right, Matrix2x3 &result)
{
...
void Matrix2x3::multiply(const Matrix2x3 &left, const Vector3 &right, Vector2 &result)
{
...
void Matrix2x3::multiply(const Vector2 &left, const Matrix2x3 &right, Vector3 &result)
{
...
Matrix2x3 Matrix2x3::inverse(const Matrix2x3 &mat23)
{
    Matrix2x3 result;
...
Matrix3x2 Matrix2x3::transpose(const Matrix2x3 &mat23)
{
    Matrix3x2 result;
...
Matrix2x3 Matrix2x3::add(const Matrix2x3 &left, const Matrix2x3 &right)
{
    Matrix2x3 result;
...
Matrix2x3 Matrix2x3::subtract(const Matrix2x3 &left, const Matrix2x3 &right)
{
    Matrix2x3 result;
...
Matrix2x3 Matrix2x3::multiply(const Matrix2x3 &left, float right)
{
    Matrix2x3 result;
...
Matrix2x3 Matrix2x3::multiply(float left, const Matrix2x3 &right)
{
    Matrix2x3 result;
    multiply(left, right, result);
    return result;
...
Matrix2x2 Matrix2x3::multiply(const Matrix2x3 &left, const Matrix3x2 &right)
{
    Matrix2x2 result;
    multiply(left, right, result);
    return result;
...
Matrix2x3 Matrix2x3::multiply(const Matrix2x3 &left, const Matrix3x3 &right)
{
    Matrix2x3 result;
    multiply(left, right, result);
    return result;
...
Matrix2x4 Matrix2x3::multiply(const Matrix2x3 &left, const Matrix3x4 &right)
{
    Matrix2x4 result;
    multiply(left, right, result);
    return result;
...
Vector2 Matrix2x3::multiply(const Matrix2x3 &left, const Vector3 &right)
{
    Vector2 result;
    multiply(left, right, result);
    return result;
...
Vector3 Matrix2x3::multiply(const Vector2 &left, const Matrix2x3 &right)
{
    Vector3 result;
    multiply(left, right, result);
    return result;
...
Matrix2x3 &Matrix2x3::operator=(const Matrix2x3 &mat23)
{
    m_mat[0][0] = mat23.m_mat[0][0];
    m_mat[0][1] = mat23.m_mat[0][1];
    m_mat[0][2] = mat23.m_mat[0][2];
...
bool operator==(const Matrix2x3 &m1, const Matrix2x3 &m2)
{
    for (int r = 0; r < 2; r++)
    {
        for (int c = 0; c < 3; c++)
...
Matrix2x2 operator*(const Matrix2x3 &m23, const Matrix3x2 &m32)
{
    return Matrix2x3::multiply(m23, m32);
}

Matrix2x3 operator*(const Matrix2x3 &m23, const Matrix3x3 &m33)
{
    return Matrix2x3::multiply(m23, m33);
}

Matrix2x4 operator*(const Matrix2x3 &m23, const Matrix3x4 &m34)
{
    return Matrix2x3::multiply(m23, m34);
}

Vector2 operator*(const Matrix2x3 &mat23, const Vector3 &vec3)
{
    return Matrix2x3::multiply(mat23, vec3);
}

Vector3 operator*(const Vector2 &vec2, const Matrix2x3 &mat23)
{
