...
inline Matrix3x2::Matrix3x2(float value)
{
    m_mat[0][0] = value;
    m_mat[0][1] = value;
    m_mat[1][0] = value;
...
inline Matrix3x2::Matrix3x2(float arr[3][2])
{
    m_mat[0][0] = arr[0][0];
    m_mat[0][1] = arr[0][1];
    m_mat[1][0] = arr[1][0];
...
inline Matrix3x2::Matrix3x2(float f00, float f01,
                     float f10, float f11,
                     float f20, float f21)
{
    m_mat[0][0] = f00;
...
inline Matrix3x2::Matrix3x2(const Matrix3x2 &mat32)
{
...
inline Vector2 Matrix3x2::row(int index) const
{
    return Vector2(m_mat[index][0],
                   m_mat[index][1]);
}

inline Vector3 Matrix3x2::column(int index) const
{
...
inline void Matrix3x2::setRow(int index, const Vector2 &vec2)
{
    m_mat[index][0] = vec2.x();
    m_mat[index][1] = vec2.y();
}

inline void Matrix3x2::setColumn(int index, const Vector3 &vec3)
{
...
inline void Matrix3x2::fill(float value)
{
    m_mat[0][0] = value;
    m_mat[0][1] = value;
    m_mat[1][0] = value;
...
inline void Matrix3x2::inverse(const Matrix3x2 &mat32, Matrix3x2 &result)
{
}

inline void Matrix3x2::transpose(const Matrix3x2 &mat32, Matrix2x3 &result)
{
...
inline void Matrix3x2::add(const Matrix3x2 &left, const Matrix3x2 &right, Matrix3x2 &result)
{
...
inline void Matrix3x2::subtract(const Matrix3x2 &left, const Matrix3x2 &right, Matrix3x2 &result)
{
    result.m_mat[0][0] = left.m_mat[0][0] - right.m_mat[0][0];
    result.m_mat[0][1] = left.m_mat[0][1] - right.m_mat[0][1];
    result.m_mat[1][0] = left.m_mat[1][0] - right.m_mat[1][0];
...
inline void Matrix3x2::multiply(const Matrix3x2 &left, float right, Matrix3x2 &result)
{
...
inline void Matrix3x2::multiply(float left, const Matrix3x2 &right, Matrix3x2 &result)
{
...
inline void Matrix3x2::multiply(const Matrix3x2 &left, const Matrix2x2 &right, Matrix3x2 &result)
{
...
inline void Matrix3x2::multiply(const Matrix3x2 &left, const Matrix2x3 &right, Matrix3x3 &result)
{
    result.m_mat[0][0] = left.m_mat[0][0] * right.m_mat[0][0] + left.m_mat[0][1] * right.m_mat[1][0];
    result.m_mat[0][1] = left.m_mat[0][0] * right.m_mat[0][1] + left.m_mat[0][1] * right.m_mat[1][1];
...
inline void Matrix3x2::multiply(const Matrix3x2 &left, const Matrix2x4 &right, Matrix3x4 &result)
{
    result.m_mat[0][0] = left.m_mat[0][0] * right.m_mat[0][0] + left.m_mat[0][1] * right.m_mat[1][0];
    result.m_mat[0][1] = left.m_mat[0][0] * right.m_mat[0][1] + left.m_mat[0][1] * right.m_mat[1][1];
    result.m_mat[0][2] = left.m_mat[0][0] * right.m_mat[0][2] + left.m_mat[0][1] * right.m_mat[1][2];    
...
inline void Matrix3x2::multiply(const Matrix3x2 &left, const Vector2 &right, Vector3 &result)
{
...
inline void Matrix3x2::multiply(const Vector3 &left, const Matrix3x2 &right, Vector2 &result)
{
...
inline Matrix3x2 Matrix3x2::inverse(const Matrix3x2 &mat32)
{
    Matrix3x2 result;
...
inline Matrix2x3 Matrix3x2::transpose(const Matrix3x2 &mat32)
{
    Matrix2x3 result;
...
inline Matrix3x2 Matrix3x2::add(const Matrix3x2 &left, const Matrix3x2 &right)
{
    Matrix3x2 result;
...
inline Matrix3x2 Matrix3x2::subtract(const Matrix3x2 &left, const Matrix3x2 &right)
{
    Matrix3x2 result;
...
inline Matrix3x2 Matrix3x2::multiply(const Matrix3x2 &left, float right)
{
    Matrix3x2 result;
...
inline Matrix3x2 Matrix3x2::multiply(float left, const Matrix3x2 &right)
{
    Matrix3x2 result;
    multiply(left, right, result);
    return result;
...
inline Matrix3x2 Matrix3x2::multiply(const Matrix3x2 &left, const Matrix2x2 &right)
{
    Matrix3x2 result;
    multiply(left, right, result);
    return result;
...
inline Matrix3x3 Matrix3x2::multiply(const Matrix3x2 &left, const Matrix2x3 &right)
{
    Matrix3x3 result;
    multiply(left, right, result);
    return result;
...
inline Matrix3x4 Matrix3x2::multiply(const Matrix3x2 &left, const Matrix2x4 &right)
{
    Matrix3x4 result;
    multiply(left, right, result);
    return result;
...
inline Vector3 Matrix3x2::multiply(const Matrix3x2 &left, const Vector2 &right)
{
    Vector3 result;
    multiply(left, right, result);
    return result;
...
inline Vector2 Matrix3x2::multiply(const Vector3 &left, const Matrix3x2 &right)
{
    Vector2 result;
    multiply(left, right, result);
    return result;
...
inline Matrix3x2 &Matrix3x2::operator=(const Matrix3x2 &mat32)
{
    m_mat[0][0] = mat32.m_mat[0][0];
    m_mat[0][1] = mat32.m_mat[0][1];
    m_mat[1][0] = mat32.m_mat[1][0];
...
inline bool operator==(const Matrix3x2 &m1, const Matrix3x2 &m2)
{
    for (int r = 0; r < 3; r++)
    {
        for (int c = 0; c < 2; c++)
...
inline Matrix3x2 operator*(const Matrix3x2 &m32, const Matrix2x2 &m22)
{
    return Matrix3x2::multiply(m32, m22);
}

inline Matrix3x3 operator*(const Matrix3x2 &m32, const Matrix2x3 &m23)
{
    return Matrix3x2::multiply(m32, m23);
}

inline Matrix3x4 operator*(const Matrix3x2 &m32, const Matrix2x4 &m24)
{
    return Matrix3x2::multiply(m32, m24);
}

inline Vector3 operator*(const Matrix3x2 &mat32, const Vector2 &vec2)
{
    return Matrix3x2::multiply(mat32, vec2);
}

inline Vector2 operator*(const Vector3 &vec3, const Matrix3x2 &mat32)
{
