...
inline Vector2 Vector2::inversed() const
{
    Vector2 v = *this;
    v.inverse();
    return v;
...
inline float Vector2::angleBetween(const Vector2 &vec2) const
{
...
inline Vector2 Vector2::midPoint(const Vector2 &vec2) const
{
...
inline Vector2 Vector2::add(const Vector2 &left, const Vector2 &right)
{
    Vector2 result;
...
inline Vector2 Vector2::subtract(const Vector2 &left, const Vector2 &right)
{
    Vector2 result;
    result.m_x = left.m_x - right.m_x;
    result.m_y = left.m_y - right.m_y;
...
inline Vector2 Vector2::multiply(float left, const Vector2 &right)
{
    Vector2 result;
...
inline Vector2 Vector2::multiply(const Vector2 &left, float right)
{
    Vector2 result;
...
inline Vector2 Vector2::multiply(const Vector2 &left, const Vector2 &right)
{
    Vector2 result;
...
inline Vector2 &Vector2::operator*=(float factor)
{
    m_x *= factor;
    m_y *= factor;
    return *this; 
...
inline Vector2 operator/(const Vector2 &vec2, float divisor)
{ 
    float inv = 1.0f / divisor; 
    return multiply(vec2, inv);
}
