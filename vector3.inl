...
inline Vector3 Vector3::inversed() const
{
    Vector3 v = *this;
    v.inverse();
    return v;
...
inline float Vector3::angleBetween(const Vector3 &vec3) const
{
...
inline Vector3 Vector3::midPoint(const Vector3 &vec3) const
{
...
inline Vector3 Vector3::reflect(const Vector3 &vec3) const
{
    return Vector3(*this - (2.0f * dotProduct(vec3) * vec3));
}

inline Vector3 Vector3::add(const Vector3 &left, const Vector3 &right)
{
    Vector3 result;
...
inline Vector3 Vector3::subtract(const Vector3 &left, const Vector3 &right)
{
    Vector3 result;
    result.m_x = left.m_x - right.m_x;
    result.m_y = left.m_y - right.m_y;
...
inline Vector3 Vector3::multiply(float left, const Vector3 &right)
{
    Vector3 result;
...
inline Vector3 Vector3::multiply(const Vector3 &left, float right)
{
    Vector3 result;
...
inline Vector3 Vector3::multiply(const Vector3 &left, const Vector3 &right)
{
    Vector3 result;
    result.m_x = left.m_x * right.m_x;
    result.m_y = left.m_y * right.m_y;
