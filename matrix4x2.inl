...
inline Matrix4x2::Matrix4x2(float value)
{
    m_mat[0][0] = value;
    m_mat[0][1] = value;
    m_mat[1][0] = value;
...
inline Matrix4x2::Matrix4x2(float arr[4][2])
{
    m_mat[0][0] = arr[0][0];
    m_mat[0][1] = arr[0][1];
    m_mat[1][0] = arr[1][0];
...
inline Matrix4x2::Matrix4x2(float f00, float f01,
                     float f10, float f11,
                     float f20, float f21,
                     float f30, float f31)
{
...
inline Matrix4x2::Matrix4x2(const Matrix4x2 &mat42)
{
...
inline Vector2 Matrix4x2::row(int index) const
{
    return Vector2(m_mat[index][0],
                   m_mat[index][1]);
}

inline Vector4 Matrix4x2::column(int index) const
{    
...
inline void Matrix4x2::setRow(int index, const Vector2 &vec2)
{
    m_mat[index][0] = vec2.x();
    m_mat[index][1] = vec2.y();
}

inline void Matrix4x2::setColumn(int index, const Vector4 &vec4)
{
...
inline void Matrix4x2::fill(float value)
{
    m_mat[0][0] = value;
    m_mat[0][1] = value;
    m_mat[1][0] = value;
...
inline float Matrix4x2::determinant() const
{
   return 0.0f;
}

inline void Matrix4x2::inverse(const Matrix4x2 &mat42, Matrix4x2 &result)
{
    
}

inline void Matrix4x2::transpose(const Matrix4x2 &mat42, Matrix2x4 &result)
{
...
inline void Matrix4x2::add(const Matrix4x2 &left, const Matrix4x2 &right, Matrix4x2 &result)
{
...
inline void Matrix4x2::subtract(const Matrix4x2 &left, const Matrix4x2 &right, Matrix4x2 &result)
{
    result.m_mat[0][0] = left.m_mat[0][0] - right.m_mat[0][0];
    result.m_mat[0][1] = left.m_mat[0][1] - right.m_mat[0][1];
    result.m_mat[1][0] = left.m_mat[1][0] - right.m_mat[1][0];
...
inline void Matrix4x2::multiply(const Matrix4x2 &left, float right, Matrix4x2 &result)
{
...
inline void Matrix4x2::multiply(float left, const Matrix4x2 &right, Matrix4x2 &result)
{
...
inline void Matrix4x2::multiply(const Matrix4x2 &left, const Matrix2x2 &right, Matrix4x2 &result)
{
...
inline void Matrix4x2::multiply(const Matrix4x2 &left, const Matrix2x3 &right, Matrix4x3 &result)
{
    result.m_mat[0][0] = left.m_mat[0][0] * right.m_mat[0][0] + left.m_mat[0][1] * right.m_mat[1][0];
    result.m_mat[0][1] = left.m_mat[0][0] * right.m_mat[0][1] + left.m_mat[0][1] * right.m_mat[1][1];
...
inline void Matrix4x2::multiply(const Matrix4x2 &left, const Matrix2x4 &right, Matrix4x4 &result)
{
    result.m_mat[0][0] = left.m_mat[0][0] * right.m_mat[0][0] + left.m_mat[0][1] * right.m_mat[1][0];
    result.m_mat[0][1] = left.m_mat[0][0] * right.m_mat[0][1] + left.m_mat[0][1] * right.m_mat[1][1];
    result.m_mat[0][2] = left.m_mat[0][0] * right.m_mat[0][2] + left.m_mat[0][1] * right.m_mat[1][2];
...
inline void Matrix4x2::multiply(const Matrix4x2 &left, const Vector2 &right, Vector4 &result)
{
...
inline void Matrix4x2::multiply(const Vector4 &left, const Matrix4x2 &right, Vector2 &result)
{
...
inline Matrix4x2 Matrix4x2::inverse(const Matrix4x2 &mat42)
{
    Matrix4x2 result;
...
inline Matrix2x4 Matrix4x2::transpose(const Matrix4x2 &mat42)
{
    Matrix2x4 result;
...
inline Matrix4x2 Matrix4x2::add(const Matrix4x2 &left, const Matrix4x2 &right)
{
    Matrix4x2 result;
...
inline Matrix4x2 Matrix4x2::subtract(const Matrix4x2 &left, const Matrix4x2 &right)
{
    Matrix4x2 result;
...
inline Matrix4x2 Matrix4x2::multiply(const Matrix4x2 &left, float right)
{
    Matrix4x2 result;
...
inline Matrix4x2 Matrix4x2::multiply(float left, const Matrix4x2 &right)
{
    Matrix4x2 result;
    multiply(left, right, result);
    return result;
...
inline Matrix4x2 Matrix4x2::multiply(const Matrix4x2 &left, const Matrix2x2 &right)
{
    Matrix4x2 result;
    multiply(left, right, result);
    return result;
...
inline Matrix4x3 Matrix4x2::multiply(const Matrix4x2 &left, const Matrix2x3 &right)
{
    Matrix4x3 result;
    multiply(left, right, result);
    return result;
...
inline Matrix4x4 Matrix4x2::multiply(const Matrix4x2 &left, const Matrix2x4 &right)
{
    Matrix4x4 result;
    multiply(left, right, result);
    return result;
...
inline Vector4 Matrix4x2::multiply(const Matrix4x2 &left, const Vector2 &right)
{
    Vector4 result;
    multiply(left, right, result);
    return result;
...
inline Vector2 Matrix4x2::multiply(const Vector4 &left, const Matrix4x2 &right)
{
    Vector2 result;
    multiply(left, right, result);
    return result;
...
inline Matrix4x2 &Matrix4x2::operator=(const Matrix4x2 &mat42)
{
    m_mat[0][0] = mat42.m_mat[0][0];
    m_mat[0][1] = mat42.m_mat[0][1];
    m_mat[1][0] = mat42.m_mat[1][0];
...
inline bool operator==(const Matrix4x2 &m1, const Matrix4x2 &m2)
{
    for (int r = 0; r < 4; r++)
    {
        for (int c = 0; c < 2; c++)
...
inline Matrix4x2 operator*(const Matrix4x2 &m42, const Matrix2x2 &m22)
{
    return Matrix4x2::multiply(m42, m22);
}

inline Matrix4x3 operator*(const Matrix4x2 &m42, const Matrix2x3 &m23)
{
    return Matrix4x2::multiply(m42, m23);
}

inline Matrix4x4 operator*(const Matrix4x2 &m42, const Matrix2x4 &m24)
{
    return Matrix4x2::multiply(m42, m24);
}

inline Vector4 operator*(const Matrix4x2 &mat42, const Vector2 &vec2)
{
    return Matrix4x2::multiply(mat42, vec2);
}

inline Vector2 operator*(const Vector4 &vec4, const Matrix4x2 &mat42)
{
